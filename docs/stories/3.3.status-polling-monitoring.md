...
3. Display horizontal row of 5 stage boxes at top showing stage number, short name, and status icon (✓ complete, ⏳ running, ⌛ pending)
...
- [ ] **Task 2: Create horizontal stage boxes** (AC: 3, 4, 5)
  ...
  - [ ] Use Flexbox or Grid for horizontal layout with arrow connectors
...
**UI Consistency:**
- Match horizontal pipeline design from PRD Section 4.3
