...
- [ ] Add pytest test suite for API endpoints (TEST-001)
  - [ ] Test POST /run with valid inputs
  - [ ] Test POST /run with invalid blob URL (400)
  - [ ] Test POST /run with missing brand (404)
  - [ ] Test GET /status with valid run_id
  - [ ] Test GET /status with missing run_id (404)
  - [ ] Test GET /status with corrupted status file (500)
  - [ ] Test transform_stage1_output() edge cases

- [ ] Add unit tests for pipeline_runner.py (TEST-002)
  - [ ] Test initialize_status()
  - [ ] Test update_stage_status() for all status values
  - [ ] Test save_stage_output()
  - [ ] Mock pipeline stages to test execute_pipeline_background()
